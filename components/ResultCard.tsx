    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-[var(--dark-card)] border border-[var(--dark-border)] p-4 clip-rhomboid-sm">
                ...
                <div className="bg-[var(--dark-card)] border border-[var(--dark-border)] p-4 clip-rhomboid-sm col-span-2">
                ...
                <div className="bg-[var(--primary-yellow)] p-4 clip-rhomboid-sm col-span-2 glow-yellow">
